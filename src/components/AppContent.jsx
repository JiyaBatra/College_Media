...
/**
 * AppContent Component - Main application content with feed and sidebars
 * Contains stories, posts feed, and right sidebar with recommendations
 *
 * @component
 * @returns {React.ReactElement} Main application content
 */
const AppContent = () => {
  // ============= STATE MANAGEMENT =============
